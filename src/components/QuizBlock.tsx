...
const QuizBlock: React.FC<QuizBlockProps> = ({
  ...
  return (
    <>
      <StandardMarginsLayout styles={`${padding}`}>
                        ...
                        <div key={i} className="flex flex-col gap-2">
                          <div className="flex items-center">
                            <input
                              ...
                              className={
                                isCheckbox
                                  ? "appearance-none rounded-[4px] border border-gray-400 checked:border-[5px] checked:border-black transition-all duration-100 cursor-pointer min-w-4 w-4 h-4"
                                  : "appearance-none rounded-full border border-gray-400 checked:border-[5px] checked:border-black transition-all duration-100 cursor-pointer min-w-4 w-4 h-4"
                              }
                              checked={isSelected}
                          ...
                          {current.textField && isLastOption && isSelected && (
                            <input
                              type="text"
                              value={answers[`custom_${activeQuestion}`] || ""}
                              onChange={(e) =>
                                setAnswers({
                                  ...answers,
                                  [`custom_${activeQuestion}`]: e.target.value,
                                })
                              }
