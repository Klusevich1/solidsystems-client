  ...
  return (
    <>
      ...
      <BasicLayout>
        ...
        <WideBlockWithImage
          title="О нас"
          text_1="“Название компании” – сильная команда для разработки интернет-магазинов любого масштаба. Вот уже 5 лет создаем продуманные до мелочей сайты: смыслы и дизайны, структура, юзабилити, SEO."
